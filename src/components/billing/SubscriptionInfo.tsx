...
const SubscriptionInfo: React.FC<SubscriptionInfoProps> = ({
  ...
  return <div className="bg-muted/50 rounded-lg p-4 border border-muted-foreground/20">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          {isSubscriptionCanceling ? <p className="text-sm text-muted-foreground">
              ...
              {cardInfo && <span className="block mt-1">
        ...
        <div className="flex gap-2">
          {isSubscriptionCanceling && onRenewSubscription && <Button variant="default" size="sm" onClick={onRenewSubscription} disabled={subscriptionLoading} className="shrink-0">
              Renew Subscription
            </Button>}
